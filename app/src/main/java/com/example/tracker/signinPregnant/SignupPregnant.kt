...
import com.example.tracker.MenuActivity
import com.example.tracker.R
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.firestore.FirebaseFirestore
import kotlinx.android.synthetic.main.activity_signup_pregnant.*

class SignupPregnant : AppCompatActivity() {
    private lateinit var firebaseAuth: FirebaseAuth
    private val database by lazy { FirebaseFirestore.getInstance()}

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_signup_pregnant)
        ...
        singupgobtn.setOnClickListener() {
            ...
            firebaseAuth.createUserWithEmailAndPassword(email, password)
                .addOnCompleteListener(this) { result ->
                    ...
                    startActivity(Intent(this, SigninPregnant::class.java))
                    finish()
                }
        }
