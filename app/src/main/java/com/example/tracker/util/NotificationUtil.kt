...
import com.example.tracker.mother.AppConstants
import com.example.tracker.mother.DiapersActivity
import com.example.tracker.mother.TimerNotificationActionReceiver
    ...
    companion object{
        ...
        fun showTimerExpired(context: Context){
            ...
            nBuilder.setContentTitle("Time Expired!")
                ...
                .setContentIntent(getPendingIntentWithStack(context, DiapersActivity::class.java))
        ...
        private fun getBasicNotificationBuilder(context: Context, channelIdTimer: String, playSound: Boolean): NotificationCompat.Builder {
            ...
            val nBuilder = NotificationCompat.Builder(context, channelIdTimer).setSmallIcon(R.drawable.timer)
                .setAutoCancel(true)
                .setDefaults(0)
